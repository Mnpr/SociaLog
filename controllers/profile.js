    ...
    return {
        ...
        getProfilePage: function(req, res){
            async.parallel([
                ...
                res.render('user/profile', {title: 'Fabbootok - Profile', user:req.user, data: result1, chat:result2});
            });
        },
        ...
        overviewPage: function(req, res){
            async.parallel([
                ...
                res.render('user/overview', {title: 'Fabbootok - Overview', user:req.user, data: result1, chat:result2});
            });
        },
